...
class ArabicLightStemmer:
	...
	def __init__(self):
		...
		self.PrefixesTree = self.create_prefix_tree(self.prefix_list)
		self.SuffixesTree = self.create_suffix_tree(self.suffix_list)		
	######################################################################
	#{ Attribut Functions
	######################################################################
	...
	def create_prefix_tree(self, prefixes):
		prefixesTree={}
		...
		return prefixesTree
	def create_suffix_tree(self, suffixes):
		suffixesTree={}
